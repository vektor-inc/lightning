...
gulp.task('components_copy', (done) => {
...
gulp.task('dist_foundation', (done) => {
...
gulp.task('watch', (done) => {
    ...
    gulp.watch([
            './assets/_scss/**',
            './inc/vk-mobile-nav/package/css/**',
            './inc/vk-components/**/*.css'
        ],
        gulp.series('sass_common')
    )
