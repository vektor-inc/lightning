...
;(function($){function vk_mobile_nav_run(target){jQuery(target).click(function(){if(jQuery(this).hasClass('menu-open')){jQuery(target).each(function(){jQuery(this).removeClass('menu-open');});jQuery('.vk-mobile-nav').removeClass('vk-mobile-nav-open');jQuery('.mobile-fix-nav .vk-mobile-nav-menu-btn i').removeClass('fa-times');jQuery('.mobile-fix-nav .vk-mobile-nav-menu-btn i').addClass('fa-bars');}else{jQuery(target).each(function(){jQuery(this).addClass('menu-open');});jQuery('.vk-mobile-nav').addClass('vk-mobile-nav-open');jQuery('.mobile-fix-nav .vk-mobile-nav-menu-btn i').removeClass('fa-bars');jQuery('.mobile-fix-nav .vk-mobile-nav-menu-btn i').addClass('fa-times');}});}
