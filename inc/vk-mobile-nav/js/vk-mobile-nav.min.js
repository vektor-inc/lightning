...
;(function($){function vk_mobile_nav_close(target){jQuery(target).each(function(){jQuery(this).removeClass('menu-open');});jQuery('.vk-mobile-nav').removeClass('vk-mobile-nav-open');jQuery('.mobile-fix-nav .vk-mobile-nav-menu-btn i').removeClass('fa-times');jQuery('.mobile-fix-nav .vk-mobile-nav-menu-btn i').addClass('fa-bars');}
