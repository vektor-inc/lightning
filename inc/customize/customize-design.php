...
function lightning_print_css_common() {
	...
	if ( empty( $skin_info['bootstrap'] ) ) {
		...
		if ( isset( $options['sidebar_position'] ) && $options['sidebar_position'] === 'left' ) {
			$dynamic_css .= '@media (min-width: 992px) { .siteContent .subSection { -ms-flex-order: 1; order: 1; margin-left:0; } .siteContent .mainSection { -webkit-box-ordinal-group: 3; -ms-flex-order: 2; order: 2; margin-left: 3rem; } }';
		}
	}
