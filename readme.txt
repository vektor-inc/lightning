...
[ G3 ][ Design Bug Fix ] Fix full width blocks placed directly in the main column not fitting the section base box in a two column layout with Section Base Setting enabled on screens 992px and wider, where they left a gap on the left and stuck out to the right. If you offset them with custom CSS, remove that offset
