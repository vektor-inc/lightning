...
[ G3 ][ Spec Change ] Stop outputting swiper-container, swiper-pagination-white and swiper-button-white on the top page slider, because Swiper no longer defines them. Additional CSS written against those class names stops applying - target .swiper, .swiper-pagination or .swiper-button-next / .swiper-button-prev instead
