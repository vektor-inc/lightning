...
[ G3 ][ Spec Change ] Change the top page slider arrow to the SVG injected by Swiper v12 and later. To size it in Additional CSS, use .ltg-slide .swiper-button-next .swiper-navigation-icon { height }, and keep the existing :after { font-size } rules for Swiper 11
