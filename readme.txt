...
[ G3 ][ Spec Change ] Change the top page slider arrow to the SVG injected by Swiper v12 and later. Size it with .ltg-slide .swiper-button-next .swiper-navigation-icon { height } - the .ltg-slide prefix is required to override the theme. Keep the existing .ltg-slide .swiper-button-next:after { font-size } rules, which still apply when Swiper 11 is loaded by another plugin
