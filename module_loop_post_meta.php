...
if ( isset($lightning_theme_options['postUpdate_hidden']) && !$lightning_theme_options['postUpdate_hidden'] ) : ?>
...
<?php
// Post author
if ( isset($lightning_theme_options['postAuthor_hidden']) && !$lightning_theme_options['postAuthor_hidden'] ) : ?>
