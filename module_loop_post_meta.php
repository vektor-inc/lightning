...
<span class="vcard author entry-meta_items entry-meta_items_author<?php echo $meta_hidden_author;?>"><?php echo esc_html(get_the_author_meta( 'display_name' ));?></span></span>
