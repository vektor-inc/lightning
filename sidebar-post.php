<?php
/**
 * Sidebar for Post Template of Lightning
 *
 * @package Lightning
 */
...
if ( is_active_sidebar( $widdget_area_name ) ) {
	...
	if ( $post_loop->have_posts() ) :
		?>
		<aside class="widget">
			<h1 class="subSection-title"><?php echo esc_html__( 'Recent posts', 'lightning' ); ?></h1>
			<?php
	...
	<aside class="widget widget_categories widget_link_list">
		<nav class="localNav">
			<h1 class="subSection-title"><?php esc_html_e( 'Category', 'lightning' ); ?></h1>
			<ul>
	...
	<aside class="widget widget_archive widget_link_list">
		<nav class="localNav">
			<h1 class="subSection-title"><?php esc_html_e( 'Archive', 'lightning' ); ?></h1>
			<ul>
				<?php
				$args = array(
					'type'      => 'monthly',
