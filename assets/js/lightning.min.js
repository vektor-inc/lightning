...
jQuery(this).css({"background-position":backgroundPosition,"background-size":bg_W+'px '+bg_H+'px',});});}})(jQuery);;(function($){function vk_mobile_nav_run(target){jQuery(target).click(function(){if(jQuery(this).hasClass('menu-open')){jQuery(target).each(function(){jQuery(this).removeClass('menu-open');});jQuery('.vk-mobile-nav').removeClass('vk-mobile-nav-open');jQuery('.mobile-fix-nav .vk-mobile-nav-menu-btn i').removeClass('fa-times');jQuery('.mobile-fix-nav .vk-mobile-nav-menu-btn i').addClass('fa-bars');}else{jQuery(target).each(function(){jQuery(this).addClass('menu-open');});jQuery('.vk-mobile-nav').addClass('vk-mobile-nav-open');jQuery('.mobile-fix-nav .vk-mobile-nav-menu-btn i').removeClass('fa-bars');jQuery('.mobile-fix-nav .vk-mobile-nav-menu-btn i').addClass('fa-times');}});}
jQuery(document).ready(function(){vk_mobile_nav_run('.vk-mobile-nav-menu-btn');});})(jQuery);;(function($){function vk_menu_acc_run(){var breakPoint=5000;var bodyWidth=window.innerWidth;if(bodyWidth<=breakPoint){$.when(vk_menu_acc_clear()).done(function(){vk_menu_acc_init();vk_menu_acc_click();});}else{vk_menu_acc_clear();}}
