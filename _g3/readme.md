...
| ---- | ---- | ---- | ---- | ---- | ---- |
| 共通CSS | enqueue_block_assets | - | wp_enqueue_style | wp-edit-blocks | lightning-common-editor-gutenberg |
| スキン | enqueue_block_assets | 11 | wp_enqueue_style | wp-edit-blocks | lightning-gutenberg-editor |
| 見出しデザイン | enqueue_block_assets | 1２ | wp_add_inline_style | lightning-common-editor-gutenberg | インライン |
| フォント切り替え | enqueue_block_assets | 1２ | wp_add_inline_style | lightning-common-editor-gutenberg | インライン |
| VK Blocks |
