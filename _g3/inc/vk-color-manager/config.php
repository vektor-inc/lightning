...
if ( ! class_exists( 'VK_Color_Manager' ) ) {
	/**
	 * Cope with compatible（ inc/functions-compatible.php )
	 * 一定期間過ぎたら管理画面でのみ実行に移行
	 */
	// if ( function_exists( 'lightning_g3_key_color_to_manager_update' ) ) {
	// lightning_g3_key_color_to_manager_update();
	// }
	require dirname( __FILE__ ) . '/class-vk-color-manager.php';
