...
class Vk_Font_Awesome_Selector {
	...
	static function admin_font_awesome( $name ){
		...
		?>
		<style type="text/css">
		.font-awesome-selector{ display:block; overflow:scroll;height:200px;border:1px solid #e5e5e5;padding:15px;margin-bottom:1em;border-radius: 3px; background-color: #fff; }
		.font-awesome-selector li input { margin-right:10px; }
