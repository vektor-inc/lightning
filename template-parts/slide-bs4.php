...
if ( apply_filters( 'lightning_default_slide_display', true ) ) {
	...
	if ( $top_slide_count ) :
		...
		$effect = '';
		if ( isset( $lightning_theme_options['top_slide_effect'] ) && 'fade' === $lightning_theme_options['top_slide_effect'] ) {
			$effect = ' carousel-fade';
		}
		?>
		<div id="top__fullcarousel" data-interval="<?php echo esc_attr( $interval ); ?>" class="carousel slide slide-main<?php echo esc_attr( $effect ); ?>" data-ride="carousel">
			...
			<?php if ( $top_slide_count >= 2 ) : ?>
				...
				<ol class="carousel-indicators">
					...
					<li data-target="#top__fullcarousel" data-slide-to="<?php echo esc_attr( $i ); ?>"></li>
						<?php
						$i++;
					}
					?>
			...
			<div class="carousel-inner">
				...
				for ( $i = 1; $i <= $top_slide_count_max; ) {
					...
					if ( ! empty( $lightning_theme_options[ 'top_slide_image_' . $i ] ) ) {
						...
						?>
						<div class="carousel-item item item-<?php echo esc_attr( $i ); ?><?php echo esc_attr( $active ); ?>">
							...
							<div class="slide-text-set mini-content">
								...
								VK_Component_Mini_Contents::the_view( $mini_content_args );
								?>
